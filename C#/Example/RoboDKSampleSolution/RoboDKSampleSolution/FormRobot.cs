namespace RoboDKSampleSolution
{
    using System;
    ...
    public partial class FormRobot : Form
    {
        ...
        private void FormRobot_Load(object sender, EventArgs e)
        {
            ...
            if (!Check_RDK())
            {
                ...
                this.Icon = Properties.Resources.IconRoboDK;
            }
        }
        ...
        */
        ...
        private void btnRunTestProgram_Click(object sender, EventArgs e)
        {
            ...
            int n_robots = 10;
            int n_tests = 100;
            var robot_list = new List<RoboDK.Item>();
            var joints_list = new List<double[]>();
        ...
        private void Setup_Notification_Icon()
        {
            ...
            ProcessTaskBar.Icon = Properties.Resources.IconRoboDK;
