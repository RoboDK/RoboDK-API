...
#
# The macros ArcStart, ArcEnd and Arc, all behave the same way, the only difference is the default behavior
...
#
# It is possible to call ArcStart(ON) to simulate turning the material deposition ON or ArcStart(OFF) to stop simulating the gun
# Calling ArcStart(RESET) clears all displayed data.
...
#
# Examples:
#     ArcStart(ON)                 # Turn on the trace using the default color
#     ArcStart(OFF)                # Turn off the tool trace
#     ArcStart(ON, Tool 1, yellow) # Turn on the trace for tool 1 in yellow
#     ArcStart(ON, Tool 2, blue) # Turn on the trace for tool 2 in blue
#     ArcStart(OFF, Torch1)        # Turn off trace for Torch 1
#     ArcStart(ON, Torch1, #889900FF) # Turn on the trace for torch 2 in a violet color
#     ArcStart(ON, ,red)         # Turn on the trace for a generic torch in red color
#
