# This macro shows how to add new points on an object surface
...
# Create a new Point->Event_Point_Operations NEWPOINT %ID%
# Create a new Target->Event_Point_Operations NEWTARGET %ID%
# Point Coordinates->Event_Point_Operations SHOWPOINT %ID%
# Curve to Targets->Object_Events CURVE_2_TARGETS %ID%
